...
python /glusterfs/users/caustics1/nkern/OSDCStacking/caustic_mass_stack2D.py $PBS_ARRAYID @@clus_num@@ @@gal_num@@ @@line_num@@ @@method_num@@ @@cell_num@@ @@bootstrap_num@@ @@run_los@@
