...
do
	...
	do
		...
		sed -e "s:@@clus_num@@:$_clus_num:g;s:@@gal_num@@:$_gal_num:g;s:@@line_num@@:$_line_num:g;s:@@method_num@@:$_method_num:g;s:@@cell_num@@:$_cell_num:g;s:@@table_num@@:$table_num:g;s:@@run_los@@:False:g;s:@@avg_meth@@:$avg_meth:g;s:@@center_guess@@:$center_guess:g;s:@@mass_scat@@:$mass_scat:g;s:@@bootstrap_num@@:None:g;s:@@bootstrap_rep@@:None:g;s:@@data_loc@@:$_data_loc:g;s:@@write_loc@@:$_write_loc:g;s:@@center_scat@@:$center_scat:g" < caustic_params_pbs.py > $_data_loc/$_write_loc/caustic_params.py

		# Create script.sh file
		sed -e "s:@@job_name@@:$job_name:g;s:@@write_loc@@:$_write_loc:g;s:@@data_loc@@:$_data_loc:g;s:@@job_array@@:$_job_array:g" < table_run_pbs.sh > $_data_loc/$_write_loc/script.sh
